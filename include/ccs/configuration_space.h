...
//   Creators/deletion
extern ccs_error_t
ccs_create_configuration_space(ccs_configuration_space_t *configuration_space_ret);
...
//   Accessors
extern ccs_error_t
ccs_configuration_space_set_name(ccs_configuration_space_t  configuration_space,
                                 const char                *name);
...
extern ccs_error_t
ccs_configuration_space_set_user_data(ccs_configuration_space_t  configuration_space,
                                      void                      *user_data);
...
//   List Accessors
extern ccs_error_t
ccs_configuration_space_add_hyper_parameter(ccs_configuration_space_t configuration_space,
                                            ccs_hyper_parameter_t     hyper_parameter);

extern ccs_error_t
ccs_configuration_space_add_hyper_parameters(ccs_configuration_space_t  configuration_space,
                                             size_t                     num_hyper_parameters,
                                             ccs_hyper_parameter_t     *hyper_parameters);

extern ccs_error_t
ccs_configuration_space_get_num_hyper_parameters(ccs_configuration_space_t  configuration_space,
                                                 size_t                    *num_hyper_parameters_ret);

extern ccs_error_t
ccs_configuration_space_get_hyper_parameter(ccs_configuration_space_t configuration_space,
                                            size_t                    index,
                                            ccs_hyper_parameter_t    *hyper_parameter_ret);

extern ccs_error_t
ccs_configuration_space_get_hyper_parameters(ccs_configuration_space_t  configuration_space,
                                             size_t                     num_hyper_parameters,
                                             ccs_hyper_parameter_t     *hyper_parameters,
                                             size_t                    *num_hyper_parameters_ret);
