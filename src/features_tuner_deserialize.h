	...
	_ccs_object_deserialize_options_t *opts)
{
	...
	CCS_VALIDATE(_ccs_object_deserialize_with_opts_check(
		...
		CCS_OBJECT_TYPE_FEATURE_SPACE, CCS_SERIALIZE_FORMAT_BINARY,
		version, buffer_size, buffer, opts));
	...
	_ccs_object_deserialize_options_t *opts)
{
	...
	if (ttype == CCS_FEATURES_TUNER_TYPE_USER_DEFINED)
	...
	switch (ttype) {
	case CCS_FEATURES_TUNER_TYPE_RANDOM:
		CCS_VALIDATE_ERR_GOTO(
			res,
			_ccs_deserialize_bin_random_features_tuner(
		...
		break;
	case CCS_FEATURES_TUNER_TYPE_USER_DEFINED:
		CCS_VALIDATE_ERR_GOTO(
			res,
			_ccs_deserialize_bin_user_defined_features_tuner(
				features_tuner_ret, version, buffer_size,
