module CCS
  ...
  attach_function :ccs_features_tuner_get_user_data, [:ccs_features_tuner_t, :pointer], :ccs_result_t
  ...
  class FeaturesTuner < Object
    ...
    add_property :user_data, :pointer, :ccs_features_tuner_get_user_data, memoize: true
