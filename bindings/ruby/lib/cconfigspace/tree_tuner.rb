module CCS
  ...
  attach_function :ccs_create_random_tree_tuner, [:string, :ccs_objective_space_t, :pointer], :ccs_result_t
  ...
  class RandomTreeTuner < TreeTuner
    def initialize(handle = nil, retain: false, auto_release: true,
      ...
      if handle
        ...
        CCS.error_check CCS.ccs_create_random_tree_tuner(name, objective_space, ptr)
  ...
  attach_function :ccs_create_user_defined_tree_tuner, [:string, :ccs_objective_space_t, UserDefinedTreeTunerVector.by_ref, :value, :pointer], :ccs_result_t
  ...
  class UserDefinedTreeTuner < TreeTuner
    ...
    def initialize(handle = nil, retain: false, auto_release: true,
      ...
      if handle
        ...
        ptr = MemoryPointer::new(:ccs_tree_tuner_t)
        CCS.error_check CCS.ccs_create_user_defined_tree_tuner(name, objective_space, vector, tuner_data, ptr)
