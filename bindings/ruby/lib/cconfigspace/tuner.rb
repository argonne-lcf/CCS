  ...
  class UserDefinedTuner < Tuner
    ...
    def initialize(handle = nil, retain: false, auto_release: true,
      ...
      if handle
        ...
        vector = UserDefinedTuner.get_vector(del: del, ask: ask, tell: tell, get_optima: get_optima, get_history: get_history, suggest: suggest, serialize: serialize, deserialize: deserialize)
        ptr = MemoryPointer::new(:ccs_tuner_t)
    ...
    def self.get_vector(del: nil, ask: nil, tell: nil, get_optima: nil, get_history: nil, suggest: nil, serialize: nil, deserialize: nil)
      ...
      vector.wrappers = [delwrapper, askwrapper, tellwrapper, get_optimawrapper, get_historywrapper, suggestwrapper, serializewrapper, deserializewrapper]
      vector
    end
