module CCS
  ...
  attach_function :ccs_features_space_add_parameter, [:ccs_features_space_t, :ccs_parameter_t], :ccs_error_t
  attach_function :ccs_features_space_add_parameters, [:ccs_features_space_t, :size_t, :pointer], :ccs_error_t
