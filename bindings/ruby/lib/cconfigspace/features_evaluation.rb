module CCS
  ...
  class FeaturesEvaluation < Binding
    ...
    add_property :result, :ccs_evaluation_result_t, :ccs_features_evaluation_get_result, memoize: false

    def initialize(handle = nil, retain: false, auto_release: true,
                   objective_space: nil, configuration: nil, features: nil, result: :CCS_SUCCESS, values: nil)
      if handle
    ...
    def result=(res)
      CCS.error_check CCS.ccs_features_evaluation_set_result(@handle, res)
      res
    end
