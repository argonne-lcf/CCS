...
class CConfigSpaceTestConfigurationSpace < Minitest::Test
  ...
  def test_conditions
    ...
    e2 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_LESS, nodes: [h3, 0.0])
    cs.set_condition(h1, e2)
    e3 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_LESS, nodes: [h1, 0.0])
  ...
  def test_omp
    ...
    cond0 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p1, '#pragma omp #P2'])
    cond1 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p1, '#pragma omp target teams distribute #P2'])
    cond2 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p1, '#pragma omp target teams distribute #P4'])
    cond3 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p1, '#pragma omp #P3'])

    cond4 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p2, 'parallel for #P3'])
    cond5 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p2, 'parallel for #P5'])
    cond6 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p2, 'parallel for #P6'])

    cond7 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p4, 'dist_schedule(static, #P8)'])

    cond8 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p5, 'schedule(#P7)'])
    cond9 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p5, 'schedule(#P7,#P8)'])

    cond10 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p6, 'numthreads(#P9)'])

    cs.set_condition(p2, CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_OR, nodes: [cond0, cond1]))
    cs.set_condition(p4, cond2)
    cs.set_condition(p3, CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_OR, nodes: [cond3, cond4]))
    cs.set_condition(p5, cond5)
    cs.set_condition(p6, cond6)
    cs.set_condition(p7, CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_OR, nodes: [cond8, cond9]))
    cond_p8 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_OR, nodes: [cond7, cond9])
    cs.set_condition(p8, cond_p8)
    cs.set_condition(p9, cond10)

    forbiddena = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p1, '#pragma omp #P2'])
    forbiddenb = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p2, ' '])
    forbidden0 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_AND, nodes: [forbiddena, forbiddenb])

    forbiddenc = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p1, '#pragma omp #P3'])
    forbiddend = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_EQUAL, nodes: [p3, ' '])
    forbidden1 = CCS::Expression::new(type: :CCS_EXPRESSION_TYPE_AND, nodes: [forbiddenc, forbiddend])
