import ctypes as ct
from .base import Object, Error, CEnumeration, ccs_result, _ccs_get_function, ccs_context, ccs_parameter, ccs_configuration_space, ccs_configuration, ccs_datum, ccs_objective_space, ccs_evaluation, ccs_tuner, ccs_retain_object, _register_vector, _unregister_vector
...
class Tuner(Object):
  ...
  def from_handle(cls, handle, retain = True, auto_release = True):
    ...
    if v == ccs_tuner_type.RANDOM:
      ...
      raise Error(ccs_result(ccs_result.ERROR_INVALID_TUNER))
...
class UserDefinedTuner(Tuner):
  def __init__(self, handle = None, retain = False, auto_release = True,
               name = "", configuration_space = None, objective_space = None, delete = None, ask = None, tell = None, get_optimums = None, get_history = None, suggest = None, serialize = None, deserialize = None, tuner_data = None ):
    if handle is None:
