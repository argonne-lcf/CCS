...
test_equal_literal()
{
	...
	test_expression_wrapper(
		CCS_EXPRESSION_TYPE_EQUAL, 2, nodes, NULL, NULL,
		ccs_bool(CCS_FALSE), CCS_INVALID_VALUE);
...
test_equal_numerical()
{
	...
	test_expression_wrapper(
		...
		values, ccs_bool(CCS_TRUE), CCS_SUCCESS);
	values[0] = ccs_float(0.0);
	test_expression_wrapper(
		CCS_EXPRESSION_TYPE_EQUAL, 2, nodes, configuration_space,
		values, ccs_bool(CCS_FALSE), CCS_SUCCESS);
	nodes[0]  = ccs_float(1.0);
	...
	test_expression_wrapper(
		CCS_EXPRESSION_TYPE_EQUAL, 2, nodes, configuration_space,
		values, ccs_bool(CCS_TRUE), CCS_INVALID_VALUE);
...
test_arithmetic_add()
{
	...
	test_binary_arithmetic(
		...
		ccs_float(1 + 2.0), CCS_SUCCESS);

	test_binary_arithmetic(
		CCS_EXPRESSION_TYPE_ADD, ccs_float(1.0), ccs_int(2),
		ccs_float(1.0 + 2), CCS_SUCCESS);
...
test_arithmetic_modulo()
{
	...
	test_binary_arithmetic(
		...
		ccs_float(fmod(3, 2.0)), CCS_SUCCESS);

	test_binary_arithmetic(
		CCS_EXPRESSION_TYPE_MODULO, ccs_float(3.0), ccs_int(2),
		ccs_float(fmod(3.0, 2)), CCS_SUCCESS);
...
test_arithmetic_and()
{
	test_binary_arithmetic(
		...
		ccs_bool(CCS_FALSE), ccs_bool(CCS_FALSE), CCS_SUCCESS);
	...
	test_binary_arithmetic(
		CCS_EXPRESSION_TYPE_AND, ccs_bool(CCS_FALSE),
		ccs_bool(CCS_TRUE), ccs_bool(CCS_FALSE), CCS_SUCCESS);
...
test_arithmetic_greater()
{
	...
	test_binary_arithmetic(
		...
		ccs_string("foo"), ccs_bool(CCS_FALSE), CCS_SUCCESS);

	test_binary_arithmetic(
		CCS_EXPRESSION_TYPE_GREATER, ccs_string("baz"),
		ccs_string("bar"), ccs_bool(CCS_TRUE), CCS_SUCCESS);

	test_binary_arithmetic(
		CCS_EXPRESSION_TYPE_GREATER, ccs_string("bar"),
		ccs_string("bar"), ccs_bool(CCS_FALSE), CCS_SUCCESS);
}
...
test_arithmetic_less_or_equal()
{
	test_binary_arithmetic(
		...
		ccs_float(2.0), ccs_bool(CCS_TRUE), CCS_SUCCESS);

	test_binary_arithmetic(
		CCS_EXPRESSION_TYPE_LESS_OR_EQUAL, ccs_float(1.0),
		ccs_float(1.0), ccs_bool(CCS_TRUE), CCS_SUCCESS);

	test_binary_arithmetic(
		CCS_EXPRESSION_TYPE_LESS_OR_EQUAL, ccs_float(2.0),
		ccs_float(1.0), ccs_bool(CCS_FALSE), CCS_SUCCESS);
	...
	test_binary_arithmetic(
		...
		ccs_int(1), ccs_none, CCS_INVALID_VALUE);

	test_binary_arithmetic(
		CCS_EXPRESSION_TYPE_LESS_OR_EQUAL, ccs_string("bar"),
		ccs_string("foo"), ccs_bool(CCS_TRUE), CCS_SUCCESS);
...
test_arithmetic_greater_or_equal()
{
	test_binary_arithmetic(
		...
		ccs_float(2.0), ccs_bool(CCS_FALSE), CCS_SUCCESS);
	...
	test_binary_arithmetic(
		CCS_EXPRESSION_TYPE_GREATER_OR_EQUAL, ccs_float(2.0),
		ccs_int(1), ccs_bool(CCS_TRUE), CCS_SUCCESS);
