...
test_empty(void)
{
	...
	err = ccs_create_configuration_space(
		"my_config_space", 0, NULL, NULL, 0, NULL, 0, NULL,
		&configuration_space);
	assert(err == CCS_RESULT_SUCCESS);
...
test_create(void)
{
	...
	err           = ccs_create_configuration_space(
                "my_config_space", 3, NULL, NULL, 0, NULL, 0, NULL,
                &configuration_space);
	assert(err == CCS_RESULT_ERROR_INVALID_VALUE);

	err = ccs_create_configuration_space(
		"my_config_space", 3, parameters, NULL, 0, NULL, 0, NULL,
		&configuration_space);
...
test_sample(void)
{
	...
	err = ccs_create_configuration_space(
		"my_config_space", 4, parameters, NULL, 0, NULL, 0, NULL,
		&configuration_space);
	assert(err == CCS_RESULT_SUCCESS);
...
test_deserialize(void)
{
	...
	err = ccs_create_configuration_space(
		"my_config_space", 3, parameters, conditions, 1, &expression, 0, NULL,
		&space);
	assert(err == CCS_RESULT_SUCCESS);
